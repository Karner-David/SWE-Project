...
function SubscriptionProduct({ subscriptionProductInfo, toggleCancel, isInCancelList }) {
    ...
    <div className='row subscription-products-row' style={{
      ...
      <div className='col subscription-products-col' style={{
        ...
        <div className='row'>
          <div className='col'>
            <ButtonRounded
              onClick={() => { if (subscriptionProductInfo.cancellable) toggleCancel(subscriptionProductInfo.subscription_id)}}
              text={subscriptionProductInfo.cancellable ? (isInCancelList ? 'Cancelled' : 'Cancel Subscription' ) : 'Not Cancellable'}
              textSize={'1rem'}
              textWeight={'700'}
              showBorder={true}
              borderColor={'#D9D9D9'}
