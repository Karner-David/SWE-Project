...
function TopNavigationBar({ 
  ...
  const transparentBackground = location.pathname == '/landing'
  ...
  return (
    <div className='container-fluid' id='main-container' style={{
      backgroundColor: logoOnly || transparentBackground ? 'transparent' : '#FFFFFF',
    }}>
      <div className='row d-flex align-items-center' id='main-row'>
              ...
              {sortByButtonData.map((button) => (
                <div className="col" key={button.id}>
                  <ButtonRounded
                    ...
                    backgroundColor={(currentSearchSortBy === button.sort) ? '#11A36F' : '#FFFFFF'}
              ...
              <div className='row' id='dropdown-order-by-row'>
                <div className='col'>
                  <ButtonRounded
                    ...
                    borderRadius={'1.5rem'}
                    paddingHorizontal={'1rem'}
                    backgroundColor={(currentSearchOrderBy === 'ascending') ? '#11A36F' : '#FFFFFF'}
                ...
                <div className='col'>
                  <ButtonRounded
                    ...
                    borderRadius={'1.5rem'}
                    paddingHorizontal={'1rem'}
                    backgroundColor={(currentSearchOrderBy === 'ascending') ? '#FFFFFF' : '#11A36F'}
        ...
        <div className='col-auto p-0 mx-2' id='cart-col'style={{
          ...
          <ButtonRounded
            ...
            backgroundColor={enableCartHighlight ? '#11A36F' : '#E6E6E6'}
