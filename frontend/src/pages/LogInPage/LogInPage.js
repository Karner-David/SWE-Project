...
function LogInPage() {
  ...
  const getTranslateMaskX = () => {
    ...
    return startAnimations ? 'translateX(0%)' : 'translateX(-100%)'
  }

  const getTranslateLogInX = () => {
    if (isSignUp) {
    ...
    return startAnimations ? 'translateX(0%)' : 'translateX(-100vw)'
  }
    ...
    <div className='container-fluid d-flex justify-content-center'>
      ...
      <div className='row h-100' id='main-row'>
        ...
        <div 
          id='left-mask'
          style={{
            transform: getTranslateMaskX(),
            width: isLogIn ? '120vw' : 'calc((100vw - (100vh * (16 / 9))) / 2)'
          }}
        />
